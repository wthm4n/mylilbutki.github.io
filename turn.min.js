                                ...
                                if (turnData.opts.gradients) {
                                    ...
                                    gradient(
                                        ...
                                        [
                                            ...
                                            [
                                                (1 - gradientStartVal) * 0.75 + gradientStartVal,
                                                "rgba(0,0,0," + 0.28 * gradientOpacity + ")",
                                            ],
                                            [
                                                1,
                                                "rgba(255,255,255," +
                                                0.18 * gradientOpacity +
                                                ")",
                                            ],
                                        ],
                                        3,
                                    ...
                                    if (flipMethods._backGradient.call(that))
                                        gradient(
                                            ...
                                            [
                                                ...
                                                [
                                                    0.78,
                                                    "rgba(0,0,0," + 0.38 * gradientOpacity + ")",
                                                ],
                                                [1, "rgba(0,0,0,0)"],
                                            ],
                                            3,
                ...
                if (corner) {
                    ...
                    if ($.inArray(corner, flipMethods._cAllowed.call(this)) != -1) {
                        ...
                        flipMethods._showFoldedPage.call(
                            this,
                            { corner: corner, x: point.x, y: point.y },
                            animate,
                        );
                    }
                } else {
